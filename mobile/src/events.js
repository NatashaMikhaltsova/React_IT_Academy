...
const EAddedClientInfo = 'EAddedClientInfo'; //кликнута кнопка добавления информации о новом клиенте, его сэмиттирует MobileClientInfo и примет MobileCompany
const ESavedClientInfo = 'ESavedClientInfo'; //кликнута кнопка сохранения информации о клиенте, его сэмиттирует MobileClientInfo и примет MobileCompany
const ECanceledClientInfo = 'ECanceledClientInfo'; //кликнута кнопка отмены изменения/добавления информации о клиенте, его сэмиттирует MobileClientInfo и примет MobileCompany
